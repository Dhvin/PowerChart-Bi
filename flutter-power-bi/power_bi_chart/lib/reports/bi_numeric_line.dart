...
class BiNumericLine extends StatelessWidget {
  final List<PipelineSeries> data;
  final List<PipelineSeries> lineData1;
  final List<PipelineSeries> lineData2;

  BiNumericLine({@required this.data, this.lineData1, this.lineData2});
        ...
        children: <Widget>[
          Expanded(
            child: charts.LineChart(
              ...
              domainAxis: new charts.NumericAxisSpec(showAxisLine: true),
