...
import 'package:power_bi_chart/parser/bar_chart.dart';
...
class PowerBiParserPage extends StatefulWidget {
  @override
  _PowerBiPageState createState() => _PowerBiPageState();
}

class _PowerBiPageState extends State<PowerBiParserPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
              ...
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Expanded(
                        child: BarChartWidgetParser()
                            .parse(dataJson1, null, context, listener)),
                  ],
                ),
              ),
            )
            ...
            /*  Card(
                      child: BarChartWidgetParser()
                          .parse(dataJson, null, context, listener)),
                  Card(
